...
export const clerkAppearance = {
    elements: {
        ...
        headerSubtitle: "text-base-content/60! text-xs! font-mono!",
        formFieldInput:
        ...
        socialButtonsBlockButtonText: "text-base-content/80! font-mono! text-xs!",
        dividerLine: "bg-base-300!",
        dividerText: "text-base-content/40! font-mono! text-xs!",
...
export const AuthContainer = ({ children }: AuthContainerProps) => (
    <div className="flex flex-col justify-center items-center p-4 w-full min-h-full">{children}</div>
);
